...
export default function HubMap({ onSelectAircraft, satelliteView = false, gateCoordinates = null }: HubMapProps = {}) {
  ...
  const initializeFlightMarkers = useCallback(() => {
    ...
    Object.entries(flightsData).forEach(([flightId, flightPath]) => {
      ...
      // else if (flightId.startsWith("vehicle1")) {
      //   el.className = "gse-vehicle-marker"
      //   dark_icon = 'gse-vehicle-icon-red.svg'
      //   light_icon = 'gse-vehicle-icon-red.svg'
      //   heading_off_set = 20
      // } else if (flightId.startsWith("vehicle2")) {
      //   el.className = "gse-vehicle-marker"
      //   dark_icon = 'gse-vehicle-icon-yellow.svg'
      //   light_icon = 'gse-vehicle-icon-yellow.svg'
      //   heading_off_set = 20
      // } else if (flightId.startsWith("vehicle3")) {
      //   el.className = "gse-vehicle-marker"
      //   dark_icon = 'gse-vehicle-icon-green.svg'
      //   light_icon = 'gse-vehicle-icon-green.svg'
      //   heading_off_set = 20
      // }
      else if (flightId.startsWith("vehicle")) {
        el.className = "gse-vehicle-marker"
      ...
      if (flightId.startsWith("flight")) {
        ...
        let aircraft = { id: "AC130", position: [-79.61579, 43.6792], status: "on-time", color: "green" }
          ...
          if (true) {
            ...
            setTimeout(() => {
              const aircraftData = {
                ...
                gate: `41`,
                statuses: {
                  OTP: 0.1 > 0.5 ? "green" : "orange",
                  HEALTH: 0.1 > 0.5 ? "green" : "orange",
                  OPS: 1 > 0.5 ? "green" : "orange",
                  TCM: 1 > 0.5 ? "green" : "orange",
                  MCC: 1 > 0.5 ? "green" : "orange",
                  ATA: 0.1 > 0.5 ? "green" : "orange",
                },
              }
        ...
        el.addEventListener("click", () => {
          console.log(`Live GSE vehicle ${'GSE1001'} clicked`)
        ...
        // Add click event handler
        el.addEventListener("click", () => {
          console.log(`Live GSE vehicle ${'GSE1006'} clicked`)
        ...
        // Add click event handler
        el.addEventListener("click", () => {
          console.log(`Live GSE vehicle ${'GSE1005'} clicked`)
  ...
  function getPTSStatus(progress,current_time,scheduled_time) {
    const diff = current_time - scheduled_time;
    const diffMinutes = diff / (1000 * 60);
    if (progress == 100) return "completed";
    if (progress == 0 && diffMinutes>15){
      return "critical";
    } else if(progress == 0 && diffMinutes>0){
      return "delayed";
    } else if(progress == 0 && diffMinutes<0){
      return "scheduled";
    } 
                  ...
                  events: [
                    {
                      ...
                      isMilestone: true,
                      status: getPTSStatus(currentPoint.arrival_progress,new Date(current_time.getTime() + currentPoint.seconds * 1000),new Date("2025-04-12T10:31:00")),
                    ...
                    },
                    {
                      ...
                      status: getPTSStatus(currentPoint.parking_progress,new Date(current_time.getTime() + currentPoint.seconds * 1000),new Date("2025-04-12T10:35:00")),
                    ...
                    },
                    {
                      ...
                      status: getPTSStatus(currentPoint.pushback_progress,new Date(current_time.getTime() + currentPoint.seconds * 1000),new Date("2025-04-12T12:20:00")),
                    ...
                    },
                    {
                      ...
                      isMilestone: true,
                      status:getPTSStatus(currentPoint.departure_progress,new Date(current_time.getTime() + currentPoint.seconds * 1000),new Date("2025-04-12T12:50:00")),
                  ...
                  events: [
                    {
                      ...
                      actualStart: currentPoint.disembarkation_progress == 0 ? null : new Date("2025-04-12T10:55:00"),
                      scheduledEnd: new Date("2025-04-12T10:55:00"),
                      actualEnd: currentPoint.disembarkation_progress < 100 ? null : new Date("2025-04-12T11:00:00"),
                      status:getPTSStatus(currentPoint.disembarkation_progress,new Date(current_time.getTime() + currentPoint.seconds * 1000),new Date("2025-04-12T10:40:00")),
                      progress: currentPoint.disembarkation_progress
                    },
                    {
                      id: "boarding",
                      name: "Boarding",
                      ...
                      actualStart: currentPoint.boarding_progress == 0 ? null : new Date("2025-04-12T11:45:00"),
                      actualEnd: currentPoint.boarding_progress < 100 ? null : new Date("2025-04-12T12:20:00"),
                      status:getPTSStatus(currentPoint.boarding_progress,new Date(current_time.getTime() + currentPoint.seconds * 1000),new Date("2025-04-12T11:45:00")),
                      progress: currentPoint.boarding_progress
                    }
                  ]
                },
                {
                  ...
                  events: [
                    {
                      ...
                      scheduledStart: new Date("2025-04-12T10:40:00"),
                      actualStart: currentPoint.baggage_unloading_progress == 0 ? null : new Date("2025-04-12T11:00:00"),
                      scheduledEnd: new Date("2025-04-12T10:55:00"),
                      actualEnd: currentPoint.baggage_unloading_progress < 100 ? null : new Date("2025-04-12T11:12:00"),
                      status:getPTSStatus(currentPoint.baggage_unloading_progress,new Date(current_time.getTime() + currentPoint.seconds * 1000),new Date("2025-04-12T10:40:00")),
                      progress: currentPoint.baggage_unloading_progress
                    },
                    {
                      id: "baggage-loading",
                      ...
                      actualStart: currentPoint.baggage_loading_progress == 0 ? null : new Date("2025-04-12T11:45:00"),
                      actualEnd: currentPoint.baggage_loading_progress < 100 ? null : new Date("2025-04-12T12:00:00"),
                      status:getPTSStatus(currentPoint.baggage_loading_progress,new Date(current_time.getTime() + currentPoint.seconds * 1000),new Date("2025-04-12T11:30:00")),
                      progress: currentPoint.baggage_loading_progress
                    }
                  ]
                },
                {
                  ...
                  events: [
                    {
                      ...
                      actualStart: currentPoint.cleaning_progress == 0 ? null : new Date("2025-04-12T11:00:00"),
                      actualEnd: currentPoint.cleaning_progress < 100 ? null : new Date("2025-04-12T11:20:00"),
                      status:getPTSStatus(currentPoint.cleaning_progress,new Date(current_time.getTime() + currentPoint.seconds * 1000),new Date("2025-04-12T10:50:00")),
                      progress: currentPoint.cleaning_progress
                    },
                    {
                      id: "refueling",
                      name: "Refueling",
                      ...
                      actualStart: currentPoint.refueling_progress == 0 ? null : new Date("2025-04-12T11:00:00"),
                      actualEnd: currentPoint.refueling_progress < 100 ? null : new Date("2025-04-12T11:30:00"),
                      status:getPTSStatus(currentPoint.refueling_progress,new Date(current_time.getTime() + currentPoint.seconds * 1000),new Date("2025-04-12T11:00:00")),
                      progress: currentPoint.refueling_progress
                    },
                    {
                      id: "catering-load",
                      name: "Catering Load",
                      ...
                      actualStart: currentPoint.catering_load_progress == 0 ? null : new Date("2025-04-12T11:10:00"),
                      actualEnd: currentPoint.catering_load_progress < 100 ? null : new Date("2025-04-12T11:40:00"),
                      status:getPTSStatus(currentPoint.catering_load_progress,new Date(current_time.getTime() + currentPoint.seconds * 1000),new Date("2025-04-12T11:15:00")),
                      progress: currentPoint.catering_load_progress
                    }
                  ]
                },
                {
                  ...
                  events: [
                    {
                      ...
                      scheduledEnd: new Date("2025-04-12T12:15:00"),
                      actualStart: currentPoint.cabin_ready_check_progress == 0 ? null : new Date("2025-04-12T12:10:00"),
                      actualEnd: currentPoint.cabin_ready_check_progress < 100 ? null : new Date("2025-04-12T12:15:00"),
                      isMilestone: true,
                      status:getPTSStatus(currentPoint.cabin_ready_check_progress,new Date(current_time.getTime() + currentPoint.seconds * 1000),new Date("2025-04-12T12:10:00")),
                      progress: currentPoint.cabin_ready_check_progress
                    },
                    {
                      id: "load-sheet",
                      ...
                      scheduledStart: new Date("2025-04-12T12:10:00"),
                      scheduledEnd: new Date("2025-04-12T12:15:00"),
                      actualStart: currentPoint.load_sheet_progress == 0 ? null : new Date("2025-04-12T12:10:00"),
                      actualEnd: currentPoint.load_sheet_progress < 100 ? null : new Date("2025-04-12T12:15:00"),
                      isMilestone: true,
                      status:getPTSStatus(currentPoint.load_sheet_progress,new Date(current_time.getTime() + currentPoint.seconds * 1000),new Date("2025-04-12T12:10:00")),
                      progress: currentPoint.load_sheet_progress
                    }
                  ]
                },
                {
                  ...
                  events: [
                    {
                      ...
                      actualStart: currentPoint.door_close_progress == 0 ? null : new Date("2025-04-12T12:15:00"),
                      actualEnd: currentPoint.door_close_progress < 100 ? null : new Date("2025-04-12T12:20:00"),
                      isMilestone: true,
                      status:getPTSStatus(currentPoint.door_close_progress,new Date(current_time.getTime() + currentPoint.seconds * 1000),new Date("2025-04-12T12:15:00")),
                      progress: currentPoint.door_close_progress
                    },
                    {
                      id: "pushback-start",
                      name: "Pushback Start",
                      scheduledStart: new Date("2025-04-12T12:20:00"),
                      scheduledEnd: new Date("2025-04-12T12:25:00"),
                      actualStart: currentPoint.pushback_start_progress == 0 ? null : new Date("2025-04-12T12:20:00"),
                      actualEnd: currentPoint.pushback_start_progress < 100 ? null : new Date("2025-04-12T12:30:00") ,
                      isMilestone: true,
                      status:getPTSStatus(currentPoint.pushback_start_progress,new Date(current_time.getTime() + currentPoint.seconds * 1000),new Date("2025-04-12T12:20:00")),
                      progress: currentPoint.pushback_start_progress
                    }
                  ]
                }
              ]
  ...
  useEffect(() => {
    ...
    const excludedVehicleIds = new Set(["GSE1001", "GSE1006", "GSE1005","GSE1004","GSE1015","GSE9022","GSE1016","GSE1013","GSE1002","GSE9020","GSE1018","GSE1007","GSE9025","GSE1010","GSE1017",])
    ...
    liveGseVehicles.forEach((vehicle) => {
      ...
      // Skip rendering if this vehicle is in the excluded list
      if (excludedVehicleIds.has(markerId)) return
